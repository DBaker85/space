...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
  ...
  _gsScope._gsDefine(
    ...
    function(TweenLite, Animation, SimpleTimeline, TimelineLite, Draggable) {
      var _doc = document,
        ...
        _timeToProgress = function(
          ...
          return Math.min(
            100,
            Math.max(0, (time / animation.duration()) * 100)
          );
        },
        ...
        _createRootElement = function(element, minimal, css) {
          ...
          var root = _createElement(
            'div',
            element ||
              _docElement.getElementsByTagName('body')[0] ||
              _docElement
          );
          root.setAttribute(
            'class',
          ...
          var _self = this,
            ...
            onPressTimeline = function(element, originRatio, limitToInOut) {
              return function(e) {
                ...
                //_merge();
                pixelToTimeRatio =
                  linkedAnimation.duration() / trackBounds.width;
            ...
            animation = function(anim) {
              var ts =
                  parseFloat(
                    timeScale.options[timeScale.selectedIndex].value
                  ) || 1,
                tl,
                maxDuration;
              if (!arguments.length) {
